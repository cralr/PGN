...
public abstract class Vehiculo {
  ...
  /**
   * Método de la clase que devolverá el total de kilómetros recorridos
  ...
  public int getKilometrosRecorridos() {
   ...
   /**
    * Método para obtener el total de km de cada vehículo por separado (coche u bicicleta) y el total de km de los vehículos.
