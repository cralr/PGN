  ...
  private void initialize() {
    ...
    btnCambioDinero.addActionListener(new ActionListener() {
      ...
      private void cambioDinero() {
        ...
        JOptionPane.showMessageDialog(frame, "No ha introducido un número.","Error",JOptionPane.ERROR_MESSAGE);
      }
     }
      
    });
    btnCambioDinero.setBounds(274,10,112,23);
